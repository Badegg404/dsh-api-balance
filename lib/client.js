window.__ModuleLoader__.load({
  id: "@githublogin0101/dsh-balance-monitor",
  factory: (require) => {
    var module = { exports: {} };
...
`;
    ...
    function ensureCss() {
      const tagId = "@githublogin0101/dsh-balance-monitor/balance.css";
      if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
        const tag = document.createElement("style");
        tag.dataset.plugin = "@githublogin0101/dsh-balance-monitor";
    ...
    function apply(ctx) {
      ...
      slots.inject("conversation.session.header.utilities", () => slots.register(
        { name: "conversation.session.header.utilities", id: "dsh-balance-monitor", order: -2, label: "余额监控" },
